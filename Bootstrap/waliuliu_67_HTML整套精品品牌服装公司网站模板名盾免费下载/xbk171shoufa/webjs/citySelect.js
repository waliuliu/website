...
; (function ($) {
    $.fn.extend({
        Citys: function (opt) {
            opt = $.extend({ Provice: ".a", City: ".b", defaul: ".defaultValue" }, opt);
            return this.each(function () {
                ...
                if ($defaul.length > 0) {
                    ...
                    if ($defaul.attr("value") != "") {
                        sheng = $defaul.attr("value").split("-")[0];
                    }
                    if ($defaul.attr("value").length > 1) {
                        shi = $defaul.attr("value").split("-")[1];
                    }
                    if ($defaul.attr("value").length > 2) {
                        quxian = $defaul.attr("value").split("-")[2];
                    }

                }

                $Province.append("<li>省</li>");
                $City.append("<li>市</li>");
                $Area.append("<li>区</li>");
                ...
                for (var i = 0; i < provice.length; i++) {
                    ...
                    $Province.append("<li value='" + provice[i] + "' " + ">" + provice[i] + "</li>");
                    if (provice[i] == sheng) {
                        $("#spanProvince").html(sheng);
                    }
                    // ci = $(".a li").index($(".a li:selected"));
                    ci = $(".a li").index($(".a li[value=" + $("#spanProvince").html() + "]"));
                }
                ...
                if (shengindex > 0 && dsy.Exists("0_" + (shengindex - 1))) {
                    ...
                    for (var i = 0; i < city11.length; i++) {
                        ...
                        $City.append("<li value='" + city11[i] + "' " + ">" + city11[i] + "</li>");
                        if (city11[i] == shi) {
                            $("#spanCity").html(shi);
                        }
                    }
                ...
                $Province.find("li").click(function () {
                    $City.html('');
                    $("#spanCity").html("市");
                    $("#spanProvince").html($(this).html());
                    ci = $(".a li").index($(".a li[value=" + $("#spanProvince").html() + "]"));
                    $City.append("<li value=''>市</li>");
                    if (ci > 0 && dsy.Exists("0_" + (ci - 1))) {
                        var city = dsy.Items["0_" + (ci - 1)];
                        for (var i = 0; i < city.length; i++)
                            $City.append("<li value='" + city[i] + "'>" + city[i] + "</li>");
                    }

                    $City.find("li").click(function () {
                        $("#spanCity").html($(this).html());
                    });
                });
            });
        }
...
$(function () {
   $("#pca").Citys({ Provice: ".a", City: ".b", defaul: ".defaultValue" });
   $(".shengshiqu").Citys({ Provice: ".a", City: ".b", defaul: ".defaultValue" });
});
