...
dsy.add("0_19_11", ["中堂镇", "东坑镇", "道滘镇", "沙田镇", "高埗镇", "石龙镇", "石排镇", "企石镇", "石碣镇", "洪梅镇", "麻涌镇", "桥头镇", "望牛墩镇", "茶山镇", "谢岗镇", "松山湖", "莞城区", "南城区", "长安镇", "寮步镇", "大岭山镇", "常平镇", "厚街镇", "樟木头镇", "大朗镇", "塘厦镇", "凤岗镇", "清溪镇", "横沥镇", "东城区", "黄江镇", "虎门镇"]);
dsy.add("0_19_13", ["南朗镇", "小榄镇", "古镇", "坦洲镇", "黄圃镇", "三乡镇", "东凤镇", "横栏镇", "三角镇", "南头镇", "沙溪镇", "五桂山镇", "阜沙镇", "东升镇", "板芙镇", "神湾镇", "港口镇", "大涌镇", "火炬开发区", "民众镇", "沙朗镇", "城区"]);
        ...
        Citys: function (opt) {
            ...
            return this.each(function () {
                ...
                for (var i = 0; i < provice.length; i++) {
                    ...
                    ci = $(".a option").index($(".a option:selected"));
                }
                ...
                $City.change(function () {
                    ...
                    var index = $(".b option").index($(".b option:selected"));
...
$(function () {
    $("#pca").Citys({ Provice: ".a", City: ".b", Area: ".c", defaul: ".defaultValue" });
    $(".shengshiqu").Citys({ Provice: ".a", City: ".b", Area: ".c", defaul: ".defaultValue" });
});
