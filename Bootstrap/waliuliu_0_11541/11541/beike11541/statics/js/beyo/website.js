...
cityArray = new Array(); 
cityArray[0] = new Array("北京","北京延庆（格兰山水）分中心|北京方庄直营店|北京回龙观（东亚尚北）分中心|北京回龙观（龙旗广场）分中心|北京朝阳（常营）分中心|北京顺义（悦港城）分中心|北京顺义（后沙峪）分中心|北京公主坟（海军大院）分中心|北京菜市口（中信城）分中心|北京朝阳立水桥（旭辉奥都）分中心|北京望京（金隅丽港）分中心|北京朝阳区（常营）分中心|北京海淀区（东九楼）分中心|倍优天地北京通州（果园）分中心|倍优天地北京朝阳（望京商业中心）直营店"); 
...
cityArray[6] = new Array("河南","河南郑州（金水区曼哈顿）分中心|河南郑州（二七区升龙商业广场）分中心|河南安阳（金龙酒店）分中心|倍优天地河南新密（青屏苑）分中心"); 
cityArray[7] = new Array("江西","江西南昌（红谷滩万达广场）分中心|江西南昌（东湖樟树林）分中心|倍优天地江西南昌（江信国际花园）分中心|倍优天地江西丰城（人和峰会）分中心"); 
...
cityArray[11] = new Array("宁夏","倍优天地宁夏银川（高尔夫小区）分中心|宁夏银川（金凤区阅海万家）分中心"); 
cityArray[12] = new Array("四川","四川广元（利州万达广场）分中心"); 
cityArray[13] = new Array("湖南","倍优天地湖南长沙（顺天黄金海岸大酒店）分中心"); 
cityArray[14] = new Array("新疆","新疆昌吉（海棠天街）分中心|新疆乌鲁木齐（火车头儿童大世界）分中心|新疆乌鲁木齐（康城果岭小区）分中心|倍优天地新疆博乐（红星路百盛大厦）分中心"); 
cityArray[15] = new Array("云南","云南昆明（北辰财富中心）分中心"); 
cityArray[16] = new Array("山东","山东胶州（香港花园）分中心|山东滨州（东方商业文化街）分中心|山东威海（文化中路）分中心|山东临沂（临沭华诚购物广场）分中心|山东海阳（银河名座）中心|山东淄博（太公路）分中心|山东东营（银座广场）分中心|倍优天地山东临沂（和谐广场）分中心|倍优天地山东烟台（莱山）分中心|倍优天地山东烟台（芝罘区大悦城）分中心|倍优天地山东济南（阳光幼儿园）分中心"); 
cityArray[17] = new Array("上海","上海松江区（绿地金御广场）分中心|上海浦东(芳华路)分中心"); 
cityArray[18] = new Array("山西","倍优天地山西忻州（世纪花园）分中心"); 
cityArray[19] = new Array("内蒙","倍优天地内蒙呼和浩特（成吉思汗大街）分中心|倍优天地内蒙呼和浩特（如意）分中心"); 
